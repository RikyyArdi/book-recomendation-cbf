...
class Cbrs
{
    ...
    # Fungsi pencarian kemiripan berdasar keyword
    # Keyword sudah melalui tahap pre-processing
    ...
    # Fungsi menghitung skor similarity ke semua dokumen
    ...
    private function cosim($d1, $d2)
    {
        ...
        return round($dx / (sqrt($dx1) * sqrt($dx2)), 3);
    }
}
