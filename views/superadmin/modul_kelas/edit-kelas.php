...
$query = "SELECT * FROM kelas WHERE kelas_id = $id_kelas";
$hasil = mysqli_query($db, $query);
$data_kelas = mysqli_fetch_assoc($hasil);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="post" action="proses-edit-kelas.php">
                                <input type="hidden" name="id_kelas" value="<?php echo $data_kelas['kelas_id']; ?>">

                                <div class="mb-3">
                                    <label class="form-label">Kelas</label>
                                    <input type="text" name="kelas" class="form-control" value="<?php echo $data_kelas['nama_kelas']; ?>">
                                </div>
