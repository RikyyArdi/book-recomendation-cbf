            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../superadmin/cetak/cetak-transaksi-peminjaman-pengembalian.php">Transaksi</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah-kelas.php" class="btn btn-success btn-icon-split">
                            <span class="icon text-dark-50">
                                </i>Tambah Data Kelas</a>
                        </span>
                    </div>
                                ...
                                <table class="table table-bordered" id="dataKelas" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($data_kelas as $kelas) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="edit-kelas.php?id_kelas=<?php echo $kelas['kelas_id']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="delete-kelas.php?id_kelas=<?php echo $kelas['kelas_id']; ?>" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                    </tbody>
