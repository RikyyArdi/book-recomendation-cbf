...
include 'proses-list-penerbit.php';
session_start();
            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Penerbit Buku</h1>
                        <a href="tambah-penerbit.php" class="btn btn-success btn-icon-split">
                            <span class="icon text-dark-50">
                                </i>Tambah Data Penerbit</a>
                        </span>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataPenerbit" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Nama Penerbit</th>
                                    ...
                                    <?php foreach ($data_penerbit as $penerbit) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="edit-penerbit.php?id_penerbit=<?php echo $penerbit['id_penerbit']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="delete-penerbit.php?id_penerbit=<?php echo $penerbit['id_penerbit']; ?>" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                    </tbody>
