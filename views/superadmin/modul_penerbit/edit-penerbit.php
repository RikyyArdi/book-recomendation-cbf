...
$data_penerbit = mysqli_fetch_assoc($hasil);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Data Penerbit</h1>
                    </div>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="post" action="proses-edit-penerbit.php">
                                <input type="hidden" name="id_penerbit" value="<?php echo $data_penerbit['id_penerbit']; ?>">
                                <div class="mb-3">
                                    <label class="form-table">Nama</label>
                                    <input type="text" name="penerbit" class="form-control" value="<?php echo $data_penerbit['nama_penerbit']; ?>">
                                </div>

                                <button type="submit" name="Update" value="Simpan" class="btn btn-primary">Edit</button>
