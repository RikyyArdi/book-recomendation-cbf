            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Kategori Buku</h1>
                        <a href="tambah-kategori.php" class="btn btn-success btn-icon-split">
                            <span class="icon text-dark-50">
                                </i>Tambah Data Kategori</a>
                        </span>
                    </div>
                                ...
                                <table class="table table-bordered" id="dataKategori" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($data_kategori as $kategori) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="edit-kategori.php?id_kategori=<?php echo $kategori['kategori_id']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="delete-kategori.php?id_kategori=<?php echo $kategori['kategori_id']; ?>" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
