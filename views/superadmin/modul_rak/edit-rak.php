...
$id_rak = $_GET['id_rak'];
$query = "SELECT * FROM rak WHERE rak_id = $id_rak";
$hasil = mysqli_query($db, $query);
$data_rak = mysqli_fetch_assoc($hasil);
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="post" action="proses-edit-rak.php">
                                <input type="hidden" name="id_rak" value="<?php echo $data_rak['rak_id']; ?>">
                                <div class="mb-3">
                                    <label class="form-label">Rak</label>
                                    <input type="text" name="rak" class="form-control" value="<?php echo $data_rak['nama_rak']; ?>" required>
                                </div>

                                <button type="submit" value="Simpan" class="btn btn-primary">Edit</button>
                                <button type="reset" class="btn btn-danger" value="Batal" onclick="self.history.back();">Batal</button>
                            </form>
                        </div>
                    </div>
                </div>
