            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Rak Perpustakaan</h1>
                        <a href="tambah-rak.php" class="btn btn-success btn-icon-split">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataRak" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Lokasi Rak</th>
                                    ...
                                    <?php foreach ($data_rak as $rak) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="edit-rak.php?id_rak=<?php echo $rak['rak_id']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="delete-rak.php?id_rak=<?php echo $rak['rak_id']; ?>" class="btn btn-hapus" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
