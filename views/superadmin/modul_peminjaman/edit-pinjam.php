                                ...
                                <div class="content">
                                    <form action="proses-edit-pinjam.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="cariBuku js-states form-control form-select" name="buku">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="tgl_pinjam" class="form-control" value="<?php echo $data_pinjam['tgl_pinjam'] ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Tanggal Jatuh Tempo</label>
                                            <input type="date" name="tgl_jatuh_tempo" class="form-control" value="<?php echo $data_pinjam['tgl_jatuh_tempo'] ?>">
                                        </div>
