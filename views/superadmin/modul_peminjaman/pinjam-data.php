            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="pinjam-data.php">Peminjaman</a>
            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="pinjam-form.php" class="btn btn-success btn-icon-split">
                                ...
                                <table class="table table-bordered" id="dataPinjam" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($data_pinjam as $pinjam) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (empty($pinjam['tgl_kembali'])) : ?>
                                                    <a class="btn btn-success btn-sm" href="../modul_pengembalian/pengembalian.php?id_pinjam=<?php echo $pinjam['pinjam_id'] ?>" class="btn btn-tambah" title="klik untuk proses pengembalian">Kembali</a>
                                                    <a class="btn btn-primary btn-sm" href="edit-pinjam.php?id_pinjam=<?php echo $pinjam['pinjam_id']; ?>&&status=<?php echo $status; ?>">Edit</a>
                                                <?php endif ?>
                                                <a class="btn btn-danger btn-sm" href="proses-delete-pinjam.php?id_pinjam=<?php echo $pinjam['pinjam_id']; ?>&&status=<?php echo $status; ?>&&buku_id=<?php echo $pinjam['buku_id']; ?>" onclick="return confirm('anda yakin akan menghapus data?')">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
