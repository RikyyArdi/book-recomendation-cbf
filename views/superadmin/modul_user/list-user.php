            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah-user.php" class="btn btn-success btn-icon-split">
                                ...
                                <table class="table table-bordered" id="dataUser" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($data_user as $user) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="edit-user.php?id_user=<?php echo $user['id']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="delete-user.php?id_user=<?php echo $user['id']; ?>" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                    </tbody>
