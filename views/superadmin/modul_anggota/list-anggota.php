            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah-anggota.php" class="btn btn-success btn-icon-split">
                            <span class="icon text-dark-50">
                                </i>Tambah Data Anggota</a>
                        </span>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataAnggota" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Nama Siswa</th>
                                            <th>Jenis Kelamin</th>
                                    ...
                                    <?php foreach ($data_anggota as $anggota) : ?>
                                        <tr>
                                            ...
                                            <td><?php echo $anggota['nama_kelas'] ?></td>
                                            <td>
                                                <a class="btn btn-primary btn-sm" href="edit-anggota.php?id_anggota=<?php echo $anggota['anggota_id']; ?>">Edit</a>
                                                <a class="btn btn-danger btn-sm" href="delete-anggota.php?id_anggota=<?php echo $anggota['anggota_id']; ?>" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                    </tbody>
