                ...
                <div class=" container-fluid">
                    ...
                    <form method="post" action="proses-pengembalian.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="<?php echo $data_pinjam['buku_judul'] ?>" class="form-control" disabled>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Anggota</label>
                            <input type="text" value="<?php echo $data_pinjam['anggota_nama'] ?>" class="form-control" disabled>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Tanggal Pinjam</label>
                            <input type="date" value="<?php echo $data_pinjam['tgl_pinjam'] ?>" class="form-control" disabled>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Tanggal Jatuh Tempo</label>
                            <input type="date" value="<?php echo $data_pinjam['tgl_jatuh_tempo'] ?>" class="form-control" disabled>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Tanggal Kembali</label>
                            <input type="date" value="<?php echo $tgl_kembali ?>" class="form-control" disabled>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Denda</label>
                            <input type="text" value="<?php echo $denda ?>" class="form-control" disabled>
                        </div>
