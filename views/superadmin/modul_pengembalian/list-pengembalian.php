            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="list-pengembalian.php">Pengembalian</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataKembali" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Buku</th>
                                            <th>Nama</th>
                                    ...
                                    <?php foreach ($data_kembali as $kembali) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-danger btn-sm" href="delete-pengembalian.php?id_kembali=<?php echo $kembali['kembali_id'] ?>" onclick="return confirm('anda yakin akan menghapus data?')">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </table>
