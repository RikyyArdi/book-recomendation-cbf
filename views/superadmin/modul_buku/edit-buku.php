...
include '../modul_penerbit/proses-list-penerbit.php';
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="../modul_user/list-user.php">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../modul_peminjaman/pinjam-data.php">Peminjaman</a>
                        <a class="collapse-item" href="../modul_pengembalian/list-pengembalian.php">Pengembalian</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="content">
                                <form method="post" action="proses-edit-buku.php" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="judul" class="form-control" value="<?php echo $data_buku['buku_judul'] ?>">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="penulis" class="form-control" value="<?php echo $data_buku['penulis'] ?>">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="rak">
                                            <?php foreach ($data_rak as $rak) : ?>
                                                <?php
                                                if ($data_buku['rak_id'] == $rak['rak_id']) {
                                                    $selected = "selected";
                                                } else {
                                                    $selected = null;
                                                }
                                                ?>
                                                <option value="<?php echo $rak['rak_id'] ?>" <?php echo $selected ?>><?php echo $rak['nama_rak'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="penerbit">
                                            <?php foreach ($data_penerbit as $penerbit) : ?>
                                                <?php
                                                if ($data_buku['id_penerbit '] == $penerbit['id_penerbit ']) {
                                                    $selected = "selected";
                                                } else {
                                                    $selected = null;
                                                }
                                                ?>
                                                <option value="<?php echo $penerbit['id_penerbit'] ?>" <?php echo $selected ?>><?php echo $penerbit['nama_penerbit'] ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="deskripsi" class="form-control"><?php echo $data_buku['buku_deskripsi'] ?></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Jumlah</label>
                                        <input type="number" name="jumlah" class="form-control" value="<?php echo $data_buku['buku_jumlah'] ?>">
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Link</label>
                                        <input type="text" name="link" class="form-control" value="<?php echo $data_buku['link'] ?>">
                                    </div>

                                    <div class="mb-3">
                                        <p>Cover</p>
                                        <input type="file" name="cover" class="form-control value=" <?php echo $data_buku['buku_cover'] ?>"">
                                    </div>
