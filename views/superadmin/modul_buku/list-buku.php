            ...
            <div id="content">
                ...
                <div class=" container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Buku Perpustakaan</h1>
                        <a href="tambah-buku.php" class="btn btn-success btn-icon-split">
                            <span class="icon text-dark-50">
                                </i>Tambah Data Buku</a>
                        </span>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataBuku" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Judul</th>
                                            <th>Kategori</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($data_buku as $buku) : ?>
                                            <tr>
                                                ...
                                                <td><img src="cover/<?php echo $buku['buku_cover'] ?>" class="img-thumbnail"></td>
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href=" edit-buku.php?id_buku=<?php echo $buku['buku_id']; ?>">Edit</a>
                                                    <a class="btn btn-danger btn-sm" href="delete-buku.php?id_buku=<?php echo $buku['buku_id']; ?>" onclick="return confirm('anda yakin akan menghapus data?');">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach ?>
                                    </tbody>
